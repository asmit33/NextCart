...
function Registration() {
  ...
  return (
    <div className="w-[100vw] h-[110vh] bg-gradient-to-l from-[#141490] to-[#0c2025] text-[white] flex flex-col items-center justify-start">
      ...
      <div className="w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px] p-[15px]">
        <span className="text-[25px] font-semibold">Registration Page</span>
        <span className="text-[16px]">
          Welcome to NextCart, Place your order
        </span>
      </div>
      <div className="max-w-[600px] w-[90%] h-[440px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center ">
        <form
          action=""
