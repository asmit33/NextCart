      ...
      <div className="w-[100%]  flex items-center justify-center flex-col lg:flex-row">
        ...
        <div className="lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px]  flex-col mt-[20px] lg:mt-[0px]">
          <p className="lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]">
            NextCart born for smart, seamless shopping—created to deliver
            quality products, trending styles, and everyday essentials in one
            place. With reliable service, fast delivery, and great value,
            NextCart makes your online shopping experience simple, satisfying,
            and stress-free.
          </p>
          <p className="lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]">
          ...
          <p className="lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px]">
            ...
            affordability, and convenience. NextCart connects customers with
